...
<p align="center">
 <b>
      The FabulousCore gives to you create a SignGUI, WorldBorder, minigame, chain based item creating and send sound & colored/timed message(s) to player(s) with easy way.
</b>
</p>
